...
export const CONSENT_VERSION = "2026-07-01-v1";
...
- Run a nightly, on-device-style check for crisis language in journal entries, purely to point you to
  support resources - never to diagnose or treat anything
...
a safety check on journal entries so we can point you to crisis support if it's ever needed.
