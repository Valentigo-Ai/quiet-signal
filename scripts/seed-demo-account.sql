...
--
-- Target: testuser123@example.com (52f981b3-cc09-4a50-8a4a-fda65bab0c1f)
--
...
set display_name = 'Alex',
    presenting_concerns = array['chronic_pain','anxiety','ptsd']::text[],
    presenting_concerns_set = true,
    updated_at = now()
where user_id = '52f981b3-cc09-4a50-8a4a-fda65bab0c1f';

insert into public.checkins (user_id, date, pain_score, anxiety_score, ptsd_score, energy_score, note)
values
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-07',3,3,2,3,'Rough night, back was bad. Managed a short walk anyway.'),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-08',3,2,2,3,null),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-09',2,2,1,2,'Physio exercises done. Slow, but something.'),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-10',3,3,2,3,null),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-12',2,2,1,2,null),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-13',2,1,1,2,'Better day. Slept through for once.'),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-14',3,2,2,3,null),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-15',2,2,2,2,null),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-16',2,1,1,1,'Got to the shop and back without needing to sit down.'),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-18',3,2,2,2,null),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-19',2,2,1,2,null),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-20',1,1,1,1,null),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-21',2,2,2,2,'Busy day, paid for it later. Need to pace better.'),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-22',2,1,1,1,null),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-24',1,1,0,1,null),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-25',2,2,1,2,null),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-26',1,1,1,1,'Good week overall. Trying to keep the walks up.'),
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f','2026-07-27',1,1,0,1,null)
...
from (values
  ('52f981b3-cc09-4a50-8a4a-fda65bab0c1f'::uuid,'2026-07-09'::date,
...
select '52f981b3-cc09-4a50-8a4a-fda65bab0c1f','Dr Patel (GP)','sms','07700 900123',false
where not exists (
